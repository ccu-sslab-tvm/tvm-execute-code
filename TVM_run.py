...
# -----------------------------------------------------------------------------
def run(model_info = model_define()):
    try:
    ...
    tvm_temp_path = '/home/yang880519/tvm_temp_tvm' # Warning：This folder will be removed every time.
    ...
    if trans_layout:
        desired_layouts = {'qnn.conv2d': ['NCHW', 'default'], 'nn.conv2d': ['NCHW', 'default'], 'nn.max_pool2d':['NCHW', 'default'], 'image.resize2d':['NCHW']}
